    ...
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
        ...
        <main class="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-16">
            ...
            <section class="w-full lg:w-auto lg:max-w-xl flex-shrink-0"> <div class="border border-white/30 w-full aspect-[4/3] flex items-center justify-center rounded-lg overflow-hidden">
                    <img src="https://i.ibb.co/vxnXJRJd/image-13.png" alt="Мышь hachiroku one - вид сверху" class="max-w-full max-h-full object-contain" />
                </div>
                 <div class="flex gap-3 mt-4"> <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition"> <img src="https://i.ibb.co/svLWFTGM/image-12.png" alt="hachiroku one - миниатюра 1" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition"> <img src="https://i.ibb.co/PZR5L7md/image-14.png" alt="hachiroku one - миниатюра 2" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition"> <img src="https://i.ibb.co/vxnXJRJd/image-13.png" alt="hachiroku one - миниатюра 3" class="max-w-full max-h-full object-contain" />
                    </div>
                </div>
            </section>

            <section class="flex-1">
                <h1 class="font-rubik-semibold text-4xl sm:text-5xl md:text-6xl text-white">hachiroku one</h1>
                ...
                <div class="mt-8 sm:mt-10">
                    ...
                    <ul class="font-rubik-light text-lg sm:text-xl text-white/80 mt-2 leading-relaxed list-disc list-inside">
                        ...
                        <li>Время работы: 40 часов при 1000 Гц</li>
                    </ul>
                </div>

                <form class="mt-10 sm:mt-12">
                    <div class="flex flex-wrap items-center gap-6 sm:gap-8">
                        <div class="font-rubik-semibold text-4xl sm:text-5xl text-white">6990 ₽</div>
