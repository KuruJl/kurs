...
<body class="bg-darkBlue text-white/80 min-h-screen w-full font-rubik-regular">
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
        ...
        <main class="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-16">
            <!-- Блок с изображениями товара без изменений -->
            <section class="w-full lg:w-auto lg:max-w-xl flex-shrink-0">
                ...
                <div class="flex gap-3 mt-4">
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                        <img src="https://i.ibb.co/svLWFTGM/image-12.png" alt="hachiroku one - миниатюра 1" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                        <img src="https://i.ibb.co/PZR5L7md/image-14.png" alt="hachiroku one - миниатюра 2" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                        <img src="https://i.ibb.co/vxnXJRJd/image-13.png" alt="hachiroku one - миниатюра 3" class="max-w-full max-h-full object-contain" />
                    </div>
                </div>
            </section>
