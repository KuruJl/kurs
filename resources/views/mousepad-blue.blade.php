...
<body class="bg-darkBlue text-white/80 min-h-screen w-full font-rubik-regular">
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
        ...
        <section class="w-full lg:w-auto lg:max-w-xl flex-shrink-0"> <div class="border border-white/30 w-full aspect-[4/3] flex items-center justify-center rounded-lg overflow-hidden">
                    <img src="https://i.ibb.co/qL0wWbdC/image-15.png" alt="Мышь hachiroku one - вид сверху" class="max-w-full max-h-full object-contain" />
                </div>
                 ...
                 <div class="flex gap-3 mt-4">
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                        <img src="https://i.ibb.co/qL0wWbdC/image-15.png" alt="hachiroku one - миниатюра 1" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                         <img src="https://i.ibb.co/zW93C0kX/image-17.png" alt="hachiroku one - миниатюра 2" class="max-w-full max-h-full object-contain" />
                    </div>
                    <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                         <img src="https://i.ibb.co/qL0wWbdC/image-15.png" alt="hachiroku one - миниатюра 3" class="max-w-full max-h-full object-contain" />
                    </div>
                </div>
            </section>
