        ...
        <div class="flex flex-col gap-8 py-8 sm:py-14 w-full px-4 sm:px-6 lg:px-8 max-w-[1320px]">
            ...
            <section class="flex flex-col gap-6 sm:gap-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    <!-- Карточка 1 -->
                    <a href="{{ url('/moonlight') }}" class="flex flex-col items-center p-6 sm:pt-12 border-2 bg-blue-600/20 hover:bg-blue-600/30 transition rounded-xl border-white/50 h-full">
                    ...
                    <!-- Карточка 2 -->
                    <a href="{{ url('/one') }}" class="flex flex-col items-center p-6 sm:pt-12 border-2 bg-blue-600/20 hover:bg-blue-600/30 transition rounded-xl border-white/50 h-full">
