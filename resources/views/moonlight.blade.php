...
<div class="bg-darkBlue min-h-screen w-full">
  <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
    <header class="flex justify-between items-center gap-4 sm:gap-0 sm:h-16">
      <div class="font-norwester text-4xl sm:text-5xl md:text-6xl text-pink-200">hachiroku</div>
      <nav class="flex items-center gap-4 sm:gap-6 md:gap-11 w-full sm:w-auto">
        <ul class="flex gap-4 sm:gap-6 md:gap-11 text-lg sm:text-xl md:text-2xl text-white md:hidden">
          <li><a href="#" class="font-rubik-light hover:opacity-80 transition">каталог</a></li>
          <li><a href="#" class="font-rubik-light hover:opacity-80 transition">поддержка</a></li>
          <li><a href="#" class="font-rubik-light hover:opacity-80 transition">корзина</a></li>
        </ul>
        <div class="text-lg sm:text-xl md:text-2xl text-white">
          <a href="#" class="font-rubik-light hover:opacity-80 transition">вход</a> |
          <a href="#" class="font-rubik-light hover:opacity-80 transition">регистрация</a>
        </div>
      </nav>
    </header>
    <main class="flex gap-8 sm:gap-10 md:gap-16 mt-8 sm:mt-12 lg:flex-col">
        <section class="flex">
<section class="w-full lg:w-full max-w-[500px]">
        <div class="border-2 border-dashed border-white w-full h-[400px] flex items-center justify-center">
          <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/46e921e3c584fc59638120fe44716206cd1dc53a" alt="hachiroku moonlight keyboard" class="max-w-full max-h-full object-contain" />
        </div>
        <div class="flex gap-2 mt-3 sm:mt-6">
          <div class="border-2 border-dashed border-white w-40 h-40 flex items-center justify-center">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/a088106b02af8fd04a12b072b7e91098583013dc" alt="hachiroku moonlight thumbnail 1" class="max-w-full max-h-full object-contain" />
          </div>
          <div class="border-2 border-dashed border-white w-40 h-40 flex items-center justify-center">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/e6ba273bfe52bbb47c3c9bfdeede81aa6e3ea4e8" alt="hachiroku moonlight thumbnail 2" class="max-w-full max-h-full object-contain" />
          </div>
          <div class="border-2 border-dashed border-white w-40 h-40 flex items-center justify-center">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/ba06c20a5ca77ca48fcde6c036f08a76db80d6cf" alt="hachiroku moonlight thumbnail 3" class="max-w-full max-h-full object-contain" />
          </div>
        </div>
      </section>
      <section class="flex-1">
        ...
        <div class="mt-10 sm:mt-12 flex items-center gap-8 sm:gap-12">
          <div class="font-rubik-semibold text-4xl sm:text-5xl md:text-6xl text-white/80">9999 ₽</div>
                    ...
                    <form action="{{ route('cart.index', $product) }}" method="POST">
                @csrf
    ...
    <section class="mt-16 sm:mt-24">
      ...
      <div class="mt-8 sm:mt-12 flex gap-6 sm:gap-8 lg:gap-14 flex-wrap justify-center">
        <div class="w-72 h-72 border-2 border-white/50 bg-blue-600/20 relative flex flex-col items-center rounded-xl hover:bg-blue-600/30 transition">
          <h3 class="font-rubik-semibold text-xl sm:text-2xl text-white/80 text-center mt-6 sm:mt-9">hachiroku loud</h3>
          <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/e247a6c7b458889788d38d6139046c37bcc51787" alt="hachiroku loud keyboard" class="max-w-full max-h-full object-contain mt-auto mb-4 sm:mb-8" />
        ...
        <div class="w-72 h-72 border-2 border-white/50 bg-blue-600/20 relative flex flex-col items-center rounded-xl hover:bg-blue-600/30 transition">
          ...
          <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/5911c5f235980b5f45d6a1fdedac84f3ae49016c" alt="hachiroku night keyboard" class="max-w-full max-h-full object-contain mt-auto mb-4 sm:mb-8" />
          <div class="absolute bottom-6 sm:bottom-8">
            <p class="font-rubik-semibold text-xl sm:text-2xl md:text-3xl font-bold rounded-3xl bg-white/80 h-12 sm:h-[50px] text-black/80 w-full max-w-[220px] flex items-center justify-center">
              6990 рублей
            </p>
        ...
        <div class="w-72 h-72 border-2 border-white/50 bg-blue-600/20 relative flex flex-col items-center rounded-xl hover:bg-blue-600/30 transition">
          ...
          <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/f1e30e2cc847e352df3581a299ba5dc39b996f14" alt="hachiroku superone keyboard" class="max-w-full max-h-full object-contain mt-auto mb-4 sm:mb-8" />
          <div class="absolute bottom-6 sm:bottom-8">
            <p class="font-rubik-semibold text-xl sm:text-2xl md:text-3xl font-bold rounded-3xl bg-white/80 h-12 sm:h-[50px] text-black/80 w-full max-w-[220px] flex items-center justify-center">
              7499 рублей
            </p>
        ...
        <div class="w-72 h-72 border-2 border-white/50 bg-blue-600/20 relative flex flex-col items-center rounded-xl hover:bg-blue-600/30 transition">
          ...
          <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75c420d8560eb2e7069012c42b44c3ad7cfc7700" alt="hachiroku mousepad" class="max-w-full max-h-full object-contain mt-auto mb-4 sm:mb-8" />
          <div class="absolute bottom-6 sm:bottom-8">
            <p class="font-rubik-semibold text-xl sm:text-2xl md:text-3xl font-bold rounded-3xl bg-white/80 h-12 sm:h-[50px] text-black/80 w-full max-w-[220px] flex items-center justify-center">
              2499 рублей
            </p>
