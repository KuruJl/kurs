...
<body class="bg-darkBlue text-white/80 min-h-screen w-full font-rubik-regular"> <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
        ...
        <main class="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-16">
            ...
            <section class="flex-1">
                <h1 class="font-rubik-semibold text-4xl sm:text-5xl md:text-6xl text-white">hachiroku moonlight</h1> <div class="mt-6 sm:mt-8">
                ...
                <div class="mt-8 sm:mt-10">
                    ...
                    <ul class="font-rubik-light text-lg sm:text-xl text-white/80 mt-2 leading-relaxed list-disc list-inside">
                        ...
                        <li>Формат: TKL (Tenkeyless)</li> <li>Размеры: 398 х 172 х 104 мм</li> <li>Вес: 850 г</li>
                        <li>Наличие Hot-Swap: да</li>
                        <li>Длина съемного кабеля: 1.8 м</li>
                    </ul>
                </div>

                <form class="mt-10 sm:mt-12"> <div class="flex flex-wrap items-center gap-6 sm:gap-8">
                        <div class="font-rubik-semibold text-4xl sm:text-5xl text-white">9999 ₽</div> <div class="flex items-center">
                            <label for="quantity" class="font-rubik-light text-white/80 mr-2 whitespace-nowrap">Количество:</label>
                            <input type="number" id="quantity" name="quantity" value="1" min="1" aria-label="Количество товара" class="bg-white/10 border border-white/30 text-white p-2 rounded-md w-16 text-center"> </div>
