            ...
            <section class="flex flex-col lg:flex-row gap-8 w-full">
                ...
                <section class="w-full lg:w-1/2">
                    ...
                    <div class="mt-6 sm:mt-8">
                        ...
                        Время работы от одного заряда - 130 часов (объём аккумулятора 500 mAh). Чип Nordic 52840 с поддержкой частоты опроса до 4000 Гц (требует специального ресивера, который можно приобрести отдельно)
                    ...
                    <div class="mt-8 sm:mt-10">
                        ...
                        <p class="font-rubik-light text-lg sm:text-xl text-white mt-2 leading-relaxed">
                            Вес: 55г<br />
                            Частота опроса: до 4000 Гц<br />
                            Время работы: 130 часов<br />
                    ...
                    <form action="{{ route('cart.add', ['product' => $product->id ?? 1]) }}" method="POST" class="mt-10 sm:mt-12">
                        ...
                        <div class="flex flex-wrap items-center gap-6 sm:gap-8">
                            ...
                            <label for="" class="font-rubik-light text-white mr-2 whitespace-nowrap">В наличии</label>
                            {{ $product->quantity }}
                        </div>
                    </form>
                </section>
