  ...
  <div class="flex flex-col gap-8 py-14 w-full px-4 sm:px-6 lg:px-8 max-w-[1320px]">
    ...
    <div class="flex flex-col sm:flex-row gap-4 sm:gap-11 items-center">
        ...
        <div class="text-lg md:text-xl lg:text-2xl text-white">
          <a style="font-family:Rubik, serif; font-weight:300" href="#login">вход</a> | 
          <a style="font-family:Rubik, serif; font-weight:300" href="#register">регистрация</a>
        </div>
      </div>
    </nav>
    ...
    <div class="flex flex-col gap-8 w-full">
      ...
      <div class="flex flex-col sm:flex-row items-center p-6 sm:p-10 w-full rounded-xl border border-white gap-6 sm:gap-0">
        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/46e921e3c584fc59638120fe44716206cd1dc53a" alt="hachiroku moonlight product" class="w-full sm:w-auto sm:h-[150px] object-cover" />
        
        <div class="flex flex-col sm:flex-row flex-1 justify-between items-center w-full sm:ml-8 gap-6 sm:gap-0">
          <h2 style="font-family:Rubik, serif; font-weight:600" class="text-2xl sm:text-3xl text-white text-center sm:text-left">hachiroku moonlight</h2>
          ...
          <div class="flex flex-col sm:flex-row gap-6 sm:gap-12 items-center">
            <div style="font-family:Rubik, serif; font-weight:600" class="flex gap-4 items-center">
              <button aria-label="Decrease quantity" class="w-5 h-5 text-3xl font-bold text-black bg-white rounded-sm cursor-pointer flex items-center justify-center">-</button>
              <span class="text-3xl font-bold text-white">2</span>
              <button aria-label="Increase quantity" class="w-5 h-5 text-3xl font-medium text-black bg-white rounded-sm cursor-pointer flex items-center justify-center">+</button>
            </div>

            <button aria-label="Remove item">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 cursor-pointer">
          ...
          <div style="font-family:Rubik, serif; font-weight:600" class="text-3xl sm:text-4xl lg:text-xxl font-medium text-white text-opacity-80">9999 ₽</div>
        </div>
      </div>

      <!-- Товар 2 -->
      <div class="flex flex-col sm:flex-row items-center p-6 sm:p-10 w-full rounded-xl border border-white gap-6 sm:gap-0">
        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/eb909492380b4fae97450a6b7fd3b583d0c8a4fe" alt="hachiroku mousepad product" class="w-full sm:w-auto sm:h-[150px] object-cover" />
        
        <div class="flex flex-col sm:flex-row flex-1 justify-between items-center w-full sm:ml-8 gap-6 sm:gap-0">
          <h2 style="font-family:Rubik, serif; font-weight:600" class="text-2xl sm:text-3xl font-bold text-white text-center sm:text-left">hachiroku mousepad</h2>
          ...
          <div style="font-family:Rubik, serif; font-weight:600" class="text-3xl sm:text-4xl lg:text-xxl font-medium text-white text-opacity-80">2499 ₽</div>
        </div>
      </div>

      <!-- Кнопка оформления заказа -->
      <button class="w-full sm:w-[400px] h-20 text-xl sm:text-2xl lg:text-3xl font-bold rounded-md border-2 border-white cursor-pointer bg-blue-600 bg-opacity-20 text-white mt-12 ml-auto">
        Оформить заказ
      </button>
    </div>
