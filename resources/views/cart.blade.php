...
<html lang="ru"> <head>
    ...
    <title>Корзина - hachiroku</title> </head>

<body class="bg-darkBlue"> <div class="flex flex-col items-center w-full min-h-screen">
  <div class="flex flex-col gap-8 py-14 w-full px-4 sm:px-6 lg:px-8 max-w-[1320px]">
    <nav class="flex flex-col sm:flex-row justify-between items-center gap-5 sm:gap-0 mb-10">
      ...
      <div class="flex flex-col sm:flex-row gap-4 sm:gap-11 items-center">
        <ul class="flex flex-col sm:flex-row gap-4 sm:gap-11 items-center text-lg md:text-xl lg:text-2xl text-white">
          <li><a  class="font-rubik-light hover:opacity-80 transition">каталог</a></li>
          <li><a  class="font-rubik-light hover:opacity-80 transition">поддержка</a></li>
          <li><a  class="font-rubik-light hover:opacity-80 transition">корзина</a></li>
        </ul>
    ...
    <div class="flex flex-col gap-8 w-full">
      <div class="flex flex-col sm:flex-row items-center p-6 sm:p-10 w-full rounded-xl border border-white gap-6 sm:gap-0">
        <img src="https://via.placeholder.com/150x150/cccccc/888888?text=Product+Image" alt="Название товара 1" class="w-full sm:w-auto sm:h-[150px] object-cover rounded-md" /> <div class="flex flex-col sm:flex-row flex-1 justify-between items-center w-full sm:ml-8 gap-6 sm:gap-0">
          <h2 style="font-family:Rubik, serif; font-weight:600" class="text-2xl sm:text-3xl text-white text-center sm:text-left">Название товара 1</h2>
      ...
      <div class="flex flex-col sm:flex-row items-center p-6 sm:p-10 w-full rounded-xl border border-white gap-6 sm:gap-0">
        ...
        <div class="flex flex-col sm:flex-row flex-1 justify-between items-center w-full sm:ml-8 gap-6 sm:gap-0">
          ...
          <div style="font-family:Rubik, serif; font-weight:600" class="text-3xl sm:text-4xl lg:text-xxl font-medium text-white text-opacity-80">1 200 ₽</div>
        </div>
      </div>
      ...
      <div class="flex justify-end w-full mt-12">
        <div class="flex flex-col items-end gap-4">
          ...
          <a  class="w-full sm:w-[400px] h-20 text-xl sm:text-2xl lg:text-3xl font-bold rounded-md border-2 border-white cursor-pointer bg-blue-600 bg-opacity-20 text-white flex items-center justify-center hover:bg-opacity-30 transition">
            Оформить заказ
          </a>
        </div>
      </div>
    ...
    <footer class="flex flex-col sm:flex-row justify-between items-center pt-16 gap-8 sm:gap-0">
      ...
      <div class="flex flex-col sm:flex-row gap-8 sm:gap-11 items-center sm:items-start">
        <nav class="flex flex-col gap-5 text-lg md:text-xl lg:text-2xl text-white text-center sm:text-left">
          <a href class="font-rubik-light hover:opacity-80 transition">каталог</a>
          <a href class="font-rubik-light hover:opacity-80 transition">поддержка</a>
          <a href class="font-rubik-light hover:opacity-80 transition">вход | регистрация</a>
        </nav>
