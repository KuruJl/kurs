...
<body class="bg-darkBlue">
            ...
            <main class="w-full">
                ...
                <section class="w-full px-0 sm:px-5 py-0 mx-auto my-0">
                    <form method="POST" action="{{ route('profile.update') }}" class="space-y-8">
                        ...
                        @if (session('success'))
                            <div class="bg-green-200 border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
    ...
    <div>
        <input type="password" id="current_password" name="current_password" class="input-field font-rubik-light text-lg sm:text-xl md:text-2xl">
