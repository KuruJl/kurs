                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                            @forelse ($filteredProducts as $product)
                                <div class="bg-Wblue rounded-xl border-2 border-white/50 overflow-hidden">
                                    <img src="{{ $product->image }}" alt="{{ $product->name }}" class="w-l12 h-24 object-cover ">
                                    <div class="p-4 sm:p-6">
                                        ...
                                        <a href="{{ $product->slug }}" class="inline-block bg-blue-600/20 text-white border-2 border-white rounded-md py-2 px-4 font-rubik-light text-lg hover:bg-blue-600/30 transition mt-2">Подробнее</a>
                                    </div>
                                </div>
                            @empty
