...
<body class="bg-darkBlue text-white/80 min-h-screen w-full font-rubik-regular"> <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14">
    ...
    <section class="w-full lg:w-auto lg:max-w-xl flex-shrink-0">
        <div class="border border-white/30 w-full aspect-[4/3] flex items-center justify-center rounded-lg overflow-hidden">
            <img src="https://i.ibb.co/HLdZWxFX/image-23.png" alt="Клавиатура hachiroku moonlight - вид сверху" class="max-w-full max-h-full object-contain" />
        </div>
        <div class="flex gap-3 mt-4">
            <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
                <img src="https://i.ibb.co/wZF7xKjN/image-24.png" alt="hachiroku moonlight - миниатюра 1" class="max-w-full max-h-full object-contain" />
            </div>
            <div class="border border-white/30 flex-1 aspect-square flex items-center justify-center rounded overflow-hidden cursor-pointer hover:border-white/70 transition">
    ...
    <section class="flex-1">
        <h1 class="font-rubik-semibold text-4xl sm:text-5xl md:text-6xl text-white">hachiroku night</h1>
